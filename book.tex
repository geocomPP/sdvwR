...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lnd.stations$MICE <-}\StringTok{ }\KeywordTok{rpois}\NormalTok{(}\DataTypeTok{n =} \KeywordTok{nrow}\NormalTok{(lnd.stations), }\DataTypeTok{lambda =} \DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
